...
public class SourceFlowTest {
	...
	static Stream<Arguments> flow() {
		...
		arguments.add( Arguments.of( x, y, q, -2, -2, 0.16547670011448873, 0, new double[]{ -0.25, -0.25 } ) );
		arguments.add( Arguments.of( x, y, q, -2, -1, 0.12807499968169406, 0, new double[]{ -0.4, -0.2 } ) );
		arguments.add( Arguments.of( x, y, q, -2, 0, 0.1103178000763258, 0, new double[]{ -0.5, 0.0 } ) );
		arguments.add( Arguments.of( x, y, q, -2, 1, 0.12807499968169406, 0, new double[]{ -0.4, 0.2 } ) );
		arguments.add( Arguments.of( x, y, q, -2, 2, 0.16547670011448873, 0, new double[]{ -0.25, 0.25 } ) );

		arguments.add( Arguments.of( x, y, q, -1, -2, 0.12807499968169406, 0, new double[]{ -0.2, -0.4 } ) );
		arguments.add( Arguments.of( x, y, q, -1, -1, 0.05515890003816291, 0, new double[]{ -0.5, -0.5 } ) );
		arguments.add( Arguments.of( x, y, q, -1, 0, 0, 0, new double[]{ -1.0, 0.0 } ) );
		arguments.add( Arguments.of( x, y, q, -1, 1, 0.05515890003816291, 0, new double[]{ -0.5, 0.5 } ) );
		arguments.add( Arguments.of( x, y, q, -1, 2, 0.12807499968169406, 0, new double[]{ -0.2, 0.4 } ) );

		arguments.add( Arguments.of( x, y, q, 0, -2, 0.1103178000763258, 0, new double[]{ 0.0, -0.5 } ) );
		arguments.add( Arguments.of( x, y, q, 0, -1, 0, 0, new double[]{ 0.0, -1.0 } ) );
